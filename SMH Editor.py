...
select_all_logo = tk.PhotoImage(file='resources/select_all.png')
...
def about():
        text_editor.delete('0.1',tk.END)
        t1="""This notepad was made by Sayed MohammadHadi Naghavi.
His gmail is s.m.hadi.naghavi@gmail.com"""
        text_editor.insert('0.1',t1)
...
edit.add_command(label='Select All',image=select_all_logo,compound=tk.LEFT,accelerator='Ctrl+A',command=lambda:text_editor.event_generate("<Control a>"))
...
edit.add_command(label='Find/Replace',image=search_logo,compound=tk.LEFT, accelerator='Ctrl+F',command=search_module)
